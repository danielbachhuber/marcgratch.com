 ...
 */
class SC_Messaging extends SC_Post_Type {
	...
	public static function init() {
		...
		self::register_post_type( self::POST_TYPE, 'Messaging', 'Messages', $post_type_args );
	}
	 ...
	 * @static
	 * @param int     $id
	 * @return Sprout_Clients_Messaging
	 */
