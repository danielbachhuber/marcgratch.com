...
class SC_Clients extends SC_Controller {
	...
	public static function comms_fields( $required = true, $client = 0 ) {
		...
		$fields['skype'] = array(
			'weight' => 15,
			'label' => self::__( 'Skype' ) . $skype_button,
			'type' => 'text',
			'required' => $required,
		...
		$fields['twitter'] = array(
			'weight' => 50,
			'label' => self::__( 'Twitter' ) . $twitter_button,
			'type' => 'text',
			'required' => $required,
		...
		$fields['facebook'] = array(
			'weight' => 55,
			'label' => self::__( 'Facebook' ) . $fb_button,
			'type' => 'text',
			'required' => $required,
		...
		$fields['linkedin'] = array(
			'weight' => 60,
			'label' => self::__( 'Linkedin' ) . $linkedin_button,
			'type' => 'text',
			'required' => $required,
	...
	public static function user_form_fields( $client_id = 0 ) {
		...
		$fields['phone'] = array(
			'weight' => 60,
			'label' => self::__( 'Phone' ),
			'placeholder' => self::__( '+1 (805) 288-2222' ),
			'type' => 'text',
			'required' => false,
		);
		...
		$fields['dob'] = array(
			'weight' => 65,
			'label' => self::__( 'Date of Birth' ),
			'placeholder' => self::__( 'Date of Birth' ),
			'type' => 'text',
			'required' => false,
		);
