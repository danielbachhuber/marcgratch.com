...
abstract class SC_Controller extends Sprout_Clients {
	...
	public static function register_resources() {
		...
		// Select2
		wp_register_style( 'sa_select2_css', SC_URL . '/resources/admin/plugins/select2/select2.css', array(), self::SC_VERSION, false );
		wp_register_script( 'sa_select2', SC_URL . '/resources/admin/plugins/select2/select2.min.js', array( 'jquery' ), self::SC_VERSION, false );
		...
		// Admin
		wp_register_script( 'sprout_clients', SC_URL . '/resources/admin/js/sprout-clients.js', array( 'jquery', 'sa_select2', 'sa_dropdown' ), self::SC_VERSION );
	...
	public static function admin_enqueue() {
		...
		if ( 
			! in_array( $screen_post_type, array( Sprout_Client::POST_TYPE ) ) &&
			strpos( $screen->base, self::TEXT_DOMAIN ) === false
			) {
			return;
		}
		wp_enqueue_script( 'sa_select2' );
		wp_enqueue_style( 'sa_select2_css' );
		...
		if ( in_array( $screen_post_type, array( Sprout_Client::POST_TYPE ) ) ) {
			if ( ! SC_FREE_TEST && file_exists( SC_PATH.'/resources/admin/plugins/redactor/redactor.min.js' ) ) {
