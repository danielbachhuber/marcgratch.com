...
<div id="<?php echo $page ?>" class="wrap">
	...
	<form method="post" enctype="multipart/form-data" action="<?php echo admin_url( 'options.php' ); ?>" class="sprout_settings_form <?php echo $page; if ( $ajax ) echo ' ajax_save'; if ( $ajax_full_page ) echo ' full_page_ajax';  ?>">
		...
		<?php submit_button(); ?>
		<?php if ( $reset ): ?>
			<?php submit_button( sc__( 'Reset Defaults' ), 'secondary', $page.'-reset', false ); ?>
		<?php endif ?>
	</form>
