...
<div class="submitbox" id="submitpost">
	...
	<div id="minor-publishing">
		<p><?php printf( self::__( '<b>Created:</b> %s' ), date( $date_format, strtotime( $post->post_date ) ) ) ?></p>
		<p><?php printf( self::__( '<b>Updated:</b> %s' ), date( $date_format, strtotime( $post->post_modified ) ) ) ?></p>
