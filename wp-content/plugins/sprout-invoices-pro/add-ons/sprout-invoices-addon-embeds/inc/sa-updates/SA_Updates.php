 ...
 * @subpackage Updates
 */
class SI_Embeds_Updates extends SI_Updates {
	...
	public static function init_edd_udpater() {
		...
		// setup the updater
		$edd_updater = new EDD_SL_Plugin_Updater_SA_Mod( self::PLUGIN_URL, SA_ADDON_EMBEDS_FILE, array(
				'item_id' => SA_ADDON_EMBEDS_DOWNLOAD_ID,		// Set the download_id manually
				'version' 	=> SA_ADDON_EMBEDS_VERSION,		// current version number
				'license' 	=> self::license_key(),	 		// license key (used get_option above to retrieve from DB)
				'item_name' => SA_ADDON_EMBEDS_NAME, 		// name of this plugin
