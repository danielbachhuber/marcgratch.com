		...
		<div class="license-overview">
			<div class="activate_message clearfix">
				...
				<div class="activation_inputs clearfix">
					<input type="text" name="<?php echo SI_Updates::LICENSE_KEY_OPTION ?>" id="<?php echo SI_Updates::LICENSE_KEY_OPTION ?>" value="<?php echo SI_Updates::license_key() ?>" class="text-input fat-input <?php echo 'license_'.SI_Free_License::license_status() ?>" size="40">
